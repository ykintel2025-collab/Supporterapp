...
export default function VoorElkaarPage() {
  ...
  return (
    <div>
      ...
      <p className="mb-4 text-sm text-gray-500">
        We staan voor elkaar klaar. Samen zorgen we voor supporters die het
        even moeilijk hebben. Bekijk de lopende acties en de voortgang.
      </p>
